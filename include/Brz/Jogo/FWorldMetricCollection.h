// ==========================================================================
//  FWorldMetricCollection — GERADO por ferramentas/gerar-headers-sdk.py. Nao edite.
//
...
// ==========================================================================
#ifndef BRZ_SDK_JOGO_FWORLDMETRICCOLLECTION_H
#define BRZ_SDK_JOGO_FWORLDMETRICCOLLECTION_H
...
struct FWorldMetricCollection
{
    ...
    { return BrzClassePorNome("FWorldMetricCollection"); }

    bool IsA(UClass* classe) const
    { return BrzEhDaClasse(this, classe); }

    // PARAMETROS do binario, com a indirecao certa. O RETORNO NAO tem segunda fonte: sai como void*, que le' certo ponteiro/int/bool (RAX) e NAO le' float/double nem struct grande. Confira antes de usar o retorno desta.
    //   FWorldMetricCollection.Reset()
    // endereco: casamento de bytes com a build de referencia
    BrzPonteiro Reset() const
    {
        return NativeCall<void*>(this, "FWorldMetricCollection.Reset()");
    }
...
#endif  // BRZ_SDK_JOGO_FWORLDMETRICCOLLECTION_H
