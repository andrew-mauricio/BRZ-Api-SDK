// ==========================================================================
//  FPrimalStats — GERADO por ferramentas/gerar-headers-sdk.py. Nao edite.
//
...
// ==========================================================================
#ifndef BRZ_SDK_JOGO_FPRIMALSTATS_H
#define BRZ_SDK_JOGO_FPRIMALSTATS_H
...
struct FPrimalStats
{
    ...
    { return BrzClassePorNome("FPrimalStats"); }

    bool IsA(UClass* classe) const
    { return BrzEhDaClasse(this, classe); }

    BrzCampoPonteiro PrimalStatsValuesField() const
...
#endif  // BRZ_SDK_JOGO_FPRIMALSTATS_H
