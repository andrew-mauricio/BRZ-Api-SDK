// ==========================================================================
//  UPrimalDinoDB — GERADO por ferramentas/gerar-headers-sdk.py. Nao edite.
//
...
// ==========================================================================
#ifndef BRZ_SDK_JOGO_UPRIMALDINODB_H
#define BRZ_SDK_JOGO_UPRIMALDINODB_H
...
struct UPrimalDinoDB
{
    static UClass* StaticClass()
    { return BrzClassePorNome("UPrimalDinoDB"); }

    bool IsA(UClass* classe) const
    { return BrzEhDaClasse(this, classe); }

    // PARAMETROS do binario, com a indirecao certa. O RETORNO NAO tem segunda fonte: sai como void*, que le' certo ponteiro/int/bool (RAX) e NAO le' float/double nem struct grande. Confira antes de usar o retorno desta.
    //   UPrimalDinoDB.AddAsset(UClass*)
    // endereco: casamento de bytes com a build de referencia
    BrzPonteiro AddAsset(void* a0) const
    {
        return NativeCall<void*, void*>(this, "UPrimalDinoDB.AddAsset(UClass*)", a0);
    }

    BrzCampoPonteiro CachedDinoDataField() const
