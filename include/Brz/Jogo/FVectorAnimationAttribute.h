// ==========================================================================
//  FVectorAnimationAttribute — GERADO por ferramentas/gerar-headers-sdk.py. Nao edite.
//
...
// ==========================================================================
#ifndef BRZ_SDK_JOGO_FVECTORANIMATIONATTRIBUTE_H
#define BRZ_SDK_JOGO_FVECTORANIMATIONATTRIBUTE_H
...
struct FVectorAnimationAttribute
{
    ...
    { return BrzClassePorNome("FVectorAnimationAttribute"); }
