// ==========================================================================
//  FLevelInstanceGuid — GERADO por ferramentas/gerar-headers-sdk.py. Nao edite.
//
...
// ==========================================================================
#ifndef BRZ_SDK_JOGO_FLEVELINSTANCEGUID_H
#define BRZ_SDK_JOGO_FLEVELINSTANCEGUID_H
...
struct FLevelInstanceGuid
{
    ...
    { return BrzClassePorNome("FLevelInstanceGuid"); }
