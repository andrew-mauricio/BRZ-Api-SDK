// ==========================================================================
//  FVectorParameterNameAndValue — GERADO por ferramentas/gerar-headers-sdk.py. Nao edite.
//
...
// ==========================================================================
#ifndef BRZ_SDK_JOGO_FVECTORPARAMETERNAMEANDVALUE_H
#define BRZ_SDK_JOGO_FVECTORPARAMETERNAMEANDVALUE_H
...
struct FVectorParameterNameAndValue
{
    ...
    { return BrzClassePorNome("FVectorParameterNameAndValue"); }
