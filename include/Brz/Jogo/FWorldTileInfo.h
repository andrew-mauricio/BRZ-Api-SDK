// ==========================================================================
//  FWorldTileInfo — GERADO por ferramentas/gerar-headers-sdk.py. Nao edite.
//
...
// ==========================================================================
#ifndef BRZ_SDK_JOGO_FWORLDTILEINFO_H
#define BRZ_SDK_JOGO_FWORLDTILEINFO_H
...
struct FWorldTileInfo
{
    ...
    { return BrzClassePorNome("FWorldTileInfo"); }

    bool IsA(UClass* classe) const
    { return BrzEhDaClasse(this, classe); }

    // PARAMETROS do binario, com a indirecao certa. O RETORNO NAO tem segunda fonte: sai como void*, que le' certo ponteiro/int/bool (RAX) e NAO le' float/double nem struct grande. Confira antes de usar o retorno desta.
    //   FWorldTileInfo.operator=(FWorldTileInfo&)
    // endereco: casamento de bytes com a build de referencia
    BrzPonteiro operator_(void* a0) const
    {
        return NativeCall<void*, void*>(this, "FWorldTileInfo.operator=(FWorldTileInfo&)", a0);
    }
    ...
    BrzCampoPonteiro AbsolutePositionField() const
