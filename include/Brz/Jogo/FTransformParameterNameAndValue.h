// ==========================================================================
//  FTransformParameterNameAndValue — GERADO por ferramentas/gerar-headers-sdk.py. Nao edite.
//
...
// ==========================================================================
#ifndef BRZ_SDK_JOGO_FTRANSFORMPARAMETERNAMEANDVALUE_H
#define BRZ_SDK_JOGO_FTRANSFORMPARAMETERNAMEANDVALUE_H
...
struct FTransformParameterNameAndValue
{
    ...
    { return BrzClassePorNome("FTransformParameterNameAndValue"); }
...
#endif  // BRZ_SDK_JOGO_FTRANSFORMPARAMETERNAMEANDVALUE_H
