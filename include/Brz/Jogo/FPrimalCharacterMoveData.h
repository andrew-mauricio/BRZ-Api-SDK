// ==========================================================================
//  FPrimalCharacterMoveData — GERADO por ferramentas/gerar-headers-sdk.py. Nao edite.
//
...
// ==========================================================================
#ifndef BRZ_SDK_JOGO_FPRIMALCHARACTERMOVEDATA_H
#define BRZ_SDK_JOGO_FPRIMALCHARACTERMOVEDATA_H
...
struct FPrimalCharacterMoveData
{
    ...
    { return BrzClassePorNome("FPrimalCharacterMoveData"); }

    bool IsA(UClass* classe) const
    { return BrzEhDaClasse(this, classe); }

    BrzCampoPonteiro MaxSpeedField() const
