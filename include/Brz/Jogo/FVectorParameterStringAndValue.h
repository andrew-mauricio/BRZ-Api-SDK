// ==========================================================================
//  FVectorParameterStringAndValue — GERADO por ferramentas/gerar-headers-sdk.py. Nao edite.
//
...
// ==========================================================================
#ifndef BRZ_SDK_JOGO_FVECTORPARAMETERSTRINGANDVALUE_H
#define BRZ_SDK_JOGO_FVECTORPARAMETERSTRINGANDVALUE_H
...
struct FVectorParameterStringAndValue
{
    ...
    { return BrzClassePorNome("FVectorParameterStringAndValue"); }
