// ==========================================================================
//  FActorPriority — GERADO por ferramentas/gerar-headers-sdk.py. Nao edite.
//
...
// ==========================================================================
#ifndef BRZ_SDK_JOGO_FACTORPRIORITY_H
#define BRZ_SDK_JOGO_FACTORPRIORITY_H
...
struct FActorPriority
{
    ...
    { return BrzClassePorNome("FActorPriority"); }

    bool IsA(UClass* classe) const
    { return BrzEhDaClasse(this, classe); }

    BrzCampoPonteiro ActorInfoField() const
...
#endif  // BRZ_SDK_JOGO_FACTORPRIORITY_H
