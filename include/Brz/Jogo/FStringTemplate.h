// ==========================================================================
//  FStringTemplate — GERADO por ferramentas/gerar-headers-sdk.py. Nao edite.
//
...
// ==========================================================================
#ifndef BRZ_SDK_JOGO_FSTRINGTEMPLATE_H
#define BRZ_SDK_JOGO_FSTRINGTEMPLATE_H
...
struct FStringTemplate
{
    static UClass* StaticClass()
    { return BrzClassePorNome("FStringTemplate"); }

    bool IsA(UClass* classe) const
    { return BrzEhDaClasse(this, classe); }

    BrzCampoPonteiro ChunksField() const
    { return BrzCampoPonteiro(GetNativePointerField<void**>(this, "FStringTemplate.Chunks")); }
    BrzCampoPonteiro LineField() const
