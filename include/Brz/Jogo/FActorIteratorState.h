// ==========================================================================
//  FActorIteratorState — GERADO por ferramentas/gerar-headers-sdk.py. Nao edite.
//
...
// ==========================================================================
#ifndef BRZ_SDK_JOGO_FACTORITERATORSTATE_H
#define BRZ_SDK_JOGO_FACTORITERATORSTATE_H
...
struct FActorIteratorState
{
    static UClass* StaticClass()
    { return BrzClassePorNome("FActorIteratorState"); }

    bool IsA(UClass* classe) const
    { return BrzEhDaClasse(this, classe); }

    // PARAMETROS do binario, com a indirecao certa. O RETORNO NAO tem segunda fonte: sai como void*, que le' certo ponteiro/int/bool (RAX) e NAO le' float/double nem struct grande. Confira antes de usar o retorno desta.
    //   FActorIteratorState.OnActorSpawned(AActor*)
    // endereco: casamento de bytes com a build de referencia
    BrzPonteiro OnActorSpawned(void* a0) const
    {
        return NativeCall<void*, void*>(this, "FActorIteratorState.OnActorSpawned(AActor*)", a0);
    }
