// ==========================================================================
//  FVectorFieldResource — GERADO por ferramentas/gerar-headers-sdk.py. Nao edite.
//
...
// ==========================================================================
#ifndef BRZ_SDK_JOGO_FVECTORFIELDRESOURCE_H
#define BRZ_SDK_JOGO_FVECTORFIELDRESOURCE_H
...
struct FVectorFieldResource
{
    ...
    { return BrzClassePorNome("FVectorFieldResource"); }
