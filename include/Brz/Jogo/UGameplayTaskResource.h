// ==========================================================================
//  UGameplayTaskResource — GERADO por ferramentas/gerar-headers-sdk.py. Nao edite.
//
...
// ==========================================================================
#ifndef BRZ_SDK_JOGO_UGAMEPLAYTASKRESOURCE_H
#define BRZ_SDK_JOGO_UGAMEPLAYTASKRESOURCE_H
...
struct UGameplayTaskResource
{
    ...
    { return BrzClassePorNome("UGameplayTaskResource"); }

    bool IsA(UClass* classe) const
    { return BrzEhDaClasse(this, classe); }

    // PARAMETROS do binario, com a indirecao certa. O RETORNO NAO tem segunda fonte: sai como void*, que le' certo ponteiro/int/bool (RAX) e NAO le' float/double nem struct grande. Confira antes de usar o retorno desta.
    //   UGameplayTaskResource.GetResourceID(TSubclassOf<UGameplayTaskResource>&)
    // endereco: casamento de bytes com a build de referencia
    BrzPonteiro GetResourceID(void* a0) const
    {
        return NativeCall<void*, void**>(this, "UGameplayTaskResource.GetResourceID(TSubclassOf<UGameplayTaskResource>&)", &a0);
    }
    ...
    signed char& AutoResourceIDField() const
...
#endif  // BRZ_SDK_JOGO_UGAMEPLAYTASKRESOURCE_H
