// ==========================================================================
//  FTransformMeshDataflowNode — GERADO por ferramentas/gerar-headers-sdk.py. Nao edite.
//
...
// ==========================================================================
#ifndef BRZ_SDK_JOGO_FTRANSFORMMESHDATAFLOWNODE_H
#define BRZ_SDK_JOGO_FTRANSFORMMESHDATAFLOWNODE_H
...
struct FTransformMeshDataflowNode
{
    ...
    { return BrzClassePorNome("FTransformMeshDataflowNode"); }

    bool IsA(UClass* classe) const
    { return BrzEhDaClasse(this, classe); }

    // PARAMETROS do binario, com a indirecao certa. O RETORNO NAO tem segunda fonte: sai como void*, que le' certo ponteiro/int/bool (RAX) e NAO le' float/double nem struct grande. Confira antes de usar o retorno desta.
    //   FTransformMeshDataflowNode.Evaluate(UE::Dataflow::FContext&,FDataflowOutput*)
    // endereco: casamento de bytes com a build de referencia
    BrzPonteiro Evaluate(void* a0, void* a1) const
    {
        return NativeCall<void*, void*, void*>(this, "FTransformMeshDataflowNode.Evaluate(UE::Dataflow::FContext&,FDataflowOutput*)", a0, a1);
    }
...
#endif  // BRZ_SDK_JOGO_FTRANSFORMMESHDATAFLOWNODE_H
