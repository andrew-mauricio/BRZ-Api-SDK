// ==========================================================================
//  UPrimalInventoryDB — GERADO por ferramentas/gerar-headers-sdk.py. Nao edite.
//
...
// ==========================================================================
#ifndef BRZ_SDK_JOGO_UPRIMALINVENTORYDB_H
#define BRZ_SDK_JOGO_UPRIMALINVENTORYDB_H
...
struct UPrimalInventoryDB
{
    static UClass* StaticClass()
    { return BrzClassePorNome("UPrimalInventoryDB"); }

    bool IsA(UClass* classe) const
    { return BrzEhDaClasse(this, classe); }

    BrzCampoPonteiro CachedInventoryDataField() const
