// ==========================================================================
//  FActorRootComponentReconstructionData — GERADO por ferramentas/gerar-headers-sdk.py. Nao edite.
//
...
// ==========================================================================
#ifndef BRZ_SDK_JOGO_FACTORROOTCOMPONENTRECONSTRUCTIONDATA_H
#define BRZ_SDK_JOGO_FACTORROOTCOMPONENTRECONSTRUCTIONDATA_H
...
struct FActorRootComponentReconstructionData
{
    ...
    { return BrzClassePorNome("FActorRootComponentReconstructionData"); }
