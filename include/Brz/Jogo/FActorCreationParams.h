// ==========================================================================
//  FActorCreationParams — GERADO por ferramentas/gerar-headers-sdk.py. Nao edite.
//
...
// ==========================================================================
#ifndef BRZ_SDK_JOGO_FACTORCREATIONPARAMS_H
#define BRZ_SDK_JOGO_FACTORCREATIONPARAMS_H
...
struct FActorCreationParams
{
    ...
    { return BrzClassePorNome("FActorCreationParams"); }
