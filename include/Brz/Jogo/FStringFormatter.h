// ==========================================================================
//  FStringFormatter — GERADO por ferramentas/gerar-headers-sdk.py. Nao edite.
//
...
// ==========================================================================
#ifndef BRZ_SDK_JOGO_FSTRINGFORMATTER_H
#define BRZ_SDK_JOGO_FSTRINGFORMATTER_H
...
struct FStringFormatter
{
    ...
    { return BrzClassePorNome("FStringFormatter"); }

    bool IsA(UClass* classe) const
    { return BrzEhDaClasse(this, classe); }

    // PARAMETROS do binario, com a indirecao certa. O RETORNO NAO tem segunda fonte: sai como void*, que le' certo ponteiro/int/bool (RAX) e NAO le' float/double nem struct grande. Confira antes de usar o retorno desta.
    //   FStringFormatter.FormatInternal(wchar_t*,TArray<FStringFormatArg,TSizedDefaultAllocator<32>>&,bo
    // endereco: casamento de bytes com a build de referencia
    BrzPonteiro FormatInternal(void* a0, void* a1, bool a2) const
    {
        return NativeCall<void*, void*, void*, bool>(this, "FStringFormatter.FormatInternal(wchar_t*,TArray<FStringFormatArg,TSizedDefaultAllocator<32>>&,bool)", a0, a1, a2);
    }
