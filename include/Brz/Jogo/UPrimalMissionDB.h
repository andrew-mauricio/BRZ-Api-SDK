// ==========================================================================
//  UPrimalMissionDB — GERADO por ferramentas/gerar-headers-sdk.py. Nao edite.
//
...
// ==========================================================================
#ifndef BRZ_SDK_JOGO_UPRIMALMISSIONDB_H
#define BRZ_SDK_JOGO_UPRIMALMISSIONDB_H
...
struct UPrimalMissionDB
{
    static UClass* StaticClass()
    { return BrzClassePorNome("UPrimalMissionDB"); }

    bool IsA(UClass* classe) const
    { return BrzEhDaClasse(this, classe); }

    BrzCampoPonteiro CachedMissionDataField() const
