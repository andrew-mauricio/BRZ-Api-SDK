// ==========================================================================
//  FStringValuePair — GERADO por ferramentas/gerar-headers-sdk.py. Nao edite.
//
...
// ==========================================================================
#ifndef BRZ_SDK_JOGO_FSTRINGVALUEPAIR_H
#define BRZ_SDK_JOGO_FSTRINGVALUEPAIR_H
...
struct FStringValuePair
{
    ...
    { return BrzClassePorNome("FStringValuePair"); }
