// ==========================================================================
//  FStringFormatArg — GERADO por ferramentas/gerar-headers-sdk.py. Nao edite.
//
...
// ==========================================================================
#ifndef BRZ_SDK_JOGO_FSTRINGFORMATARG_H
#define BRZ_SDK_JOGO_FSTRINGFORMATARG_H
...
struct FStringFormatArg
{
    ...
    { return BrzClassePorNome("FStringFormatArg"); }
    ...
    //    FStringFormatArg.operator=(FStringFormatArg&)
    //      (colide com FStringFormatArg.operator=(FStringFormatArg&&))
