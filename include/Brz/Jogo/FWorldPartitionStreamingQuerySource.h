// ==========================================================================
//  FWorldPartitionStreamingQuerySource — GERADO por ferramentas/gerar-headers-sdk.py. Nao edite.
//
...
// ==========================================================================
#ifndef BRZ_SDK_JOGO_FWORLDPARTITIONSTREAMINGQUERYSOURCE_H
#define BRZ_SDK_JOGO_FWORLDPARTITIONSTREAMINGQUERYSOURCE_H
...
struct FWorldPartitionStreamingQuerySource
{
    ...
    { return BrzClassePorNome("FWorldPartitionStreamingQuerySource"); }
    ...
    { return { (void*)this, "bSpatialQuery" }; }
    BitFieldValue<bool, unsigned __int32> bUseGridLoadingRange()
    { return { (void*)this, "bUseGridLoadingRange" }; }

};

#endif  // BRZ_SDK_JOGO_FWORLDPARTITIONSTREAMINGQUERYSOURCE_H
